...
For some of the exercises in this course, we'll need the **Bitcoin Core daemon (bitcoind)** running on Regtest. Lucky for us, Replit makes everything easy - all we have to do is click the green **Run** button at the top-left of our Repl. 
...
If this happens to you, you'll notice it because you'll see an error in the **Shell** when completing a command line exercise. No need to worry! Just click the green **Run** button again.