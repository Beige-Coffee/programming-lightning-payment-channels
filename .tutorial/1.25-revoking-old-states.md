...
If you've made it this far, the following question may be burning a whole in your mind... **"What about revoking old transaction states!?"**

So far, we've reviewed how revoking old transactions works, but we haven't seen them in action yet! Now that we've seen how to **add** and **remove** HTLCs, we're in a perfect spot to bring everything full circle and discuss how Alice and Bob revoke old states!
...
Also, note that Alice does not yet have Bob's **Funding Signature** for Alice's newest commitment version. This is another reason why Alice cannot revoke her old state yet! If she did, she would not have a *broadcastable* commitment transaction for which Bob does not have a **Revocation Secret**.
