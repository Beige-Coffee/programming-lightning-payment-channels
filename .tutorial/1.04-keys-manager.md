...
#### Once you think you've completed the function successfully, click the Run button to test your code! If it's correct, you should see that you've passed the first test.

> 💡 REMINDER: If you get stuck, don't worry! There is a `src/solutions` folder which contains the answers for each coding exercise.
