...
## Mine blocks
For a transaction to be confirmed in the blockchain, it will need to be included in a block. To do this, you can use the alias below. For this course, we'll mine blocks to open and close our lightning channels. [See documentation.](https://developer.bitcoin.org/reference/rpc/generatetoaddress.html?highlight=generatetoaddress)
👉 Try mining a block!
```
mine 1
```
