...
- `derive_private_key`: This derives Alice's **HTLC Private Key** from her **HTLC Basepoint** and the **Per-Commitment Point**. This is critical - we can't use the basepoint directly!
