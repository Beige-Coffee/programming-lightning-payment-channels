...
Unfortunately, there is no way to cancel or invalidate a bitcoin transaction after it's been created, so we need to come up with a clever way to *disincentivize* Alice and Bob from broadcasting old transactions.
