...
pub fn set_obscured_commitment_number(
    ...
    let obscured = obscure_factor ^ commitment_number;
...
Next, we need to XOR the obscure factor with the commitment number. The XOR operation then obscures this value.
