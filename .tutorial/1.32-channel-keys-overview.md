...
```rust
let revocation_basepoint_secret = key_step_derivation(&channel_seed, &b"revocation base key"[..], &commitment_seed[..]);

let payment_key = key_step_derivation(&channel_seed, &b"payment key"[..], &revocation_basepoint_secret[..]);

let delayed_payment_basepoint_secret = key_step_derivation(&channel_seed, &b"delayed payment key"[..], &payment_key[..]);

let htlc_basepoint_secret = key_step_derivation(&channel_seed, &b"HTLC base key"[..], &delayed_payment_basepoint_secret[..]);
```
