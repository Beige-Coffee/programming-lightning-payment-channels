...
- `keys_manager`: Our `ChannelKeysManager`, which can generate signatures.
...
First, let's generate our signature for the HTLC receiver output on our commitment transaction. To do this, we can use the `sign_transaction_input_sighash_all` function we created earlier in this course.
